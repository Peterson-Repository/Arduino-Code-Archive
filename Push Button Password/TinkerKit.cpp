...
// Program Description 
// When the Bottons are pushed in the correct order the green LED will glow
// When the Bottons are pushed in the incorrect order the Red LED will glow

// Correct order = Bush Buttons in order of I/O pin number down the Arduino Board
